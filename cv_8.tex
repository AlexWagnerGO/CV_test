...
\begin{cv}{\spacedallcaps{Matthew Davis}}\vspace{1.5em} % Your name

\noindent\spacedlowsmallcaps{Personal Information}\vspace{0.5em} % Personal information heading


\NewEntry{email}{\href{mailto:matthewdavisk@gmail.com}{matthewdavisk@gmail.com} \ \ $\cdotp$\ \ \href{mailto:matthekd@usc.edu}{matthekd@usc.edu}} % Email address

\NewEntry{phone}{(443)-535-2113} % Phone number(s)

\NewEntry{addresses}{(H) 2281 Ballard Way, Ellicott City MD 21042} \ \ % Addresses
\NewEntry{}{(S) 737 W. 30th Street, Los Angeles CA 91117}
...
\Description{Apply my knowledge about logic circuits and programming principals in order further my understanding of the field.}% Goal text
