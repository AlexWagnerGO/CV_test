...
\begin{cv}{\spacedallcaps{A.W.}}\vspace{1.5em} % Your name

\noindent\spacedlowsmallcaps{P. Inf.}\vspace{0.5em} % Personal information heading


\NewEntry{email}{\href{mailto:A.W.@dlr.de}{A.W.@dlr.de}}  %\href{mailto:matthekd@usc.edu}{matthekd@usc.edu}} % Email address
